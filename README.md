...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ignk86o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ignk86o.containers.anotherwebservice.com/
...
```
git clone git@github.com:Edward-Kabue/container-ignk86o.git
cd container-ignk86o
```
...
```
docker attach container-ignk86o
```
